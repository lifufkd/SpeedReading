...
@router.put("/{course_id}/exercises", status_code=status.HTTP_200_OK, response_model=CoursesNestedSchema)
...
@router.put("/{course_id}/lessons", status_code=status.HTTP_200_OK, response_model=CoursesNestedSchema)
